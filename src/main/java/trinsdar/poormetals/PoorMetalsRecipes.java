...
public class PoorMetalsRecipes {
    private static void initFurnaceRecipes() {
        ...
        if (Loader.isModLoaded("basemetals") && PoorMetalsConfig.baseMetalsPoorOres) {
            if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_antimony_ore")){

            }
            if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_bismuth_ore")){

            }
            if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_copper_ore")){

            }
            if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_lead_ore")){

            }
            if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_mercury_ore")){

            }
            if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_nickel_ore")){

            }
            if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_platinum_ore")){

            }
            if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_silver_ore")){

            }
            if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_tin_ore")){

            }
            if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_zinc_ore")){
        ...
        if (PoorMetalsConfig.netherMetalsPoorOres && (PoorMetalsConfig.modlessOres || Loader.isModLoaded("nethermetals"))){
            if (PoorMetalsConfig.vanillaPoorOres){
                if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_gold_ore") && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_nether_gold_ore")){
                ...
                if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_iron_ore") && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_nether_iron_ore")){
        ...
        if (PoorMetalsConfig.endMetalsPoorOres && (PoorMetalsConfig.modlessOres || Loader.isModLoaded("endmetals"))){
            if (PoorMetalsConfig.vanillaPoorOres){
                if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_gold_ore") && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_end_gold_ore")){
                ...
                if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_iron_ore") && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_end_iron_ore")){
            ...
            if (PoorMetalsConfig.baseMetalsPoorOres && (PoorMetalsConfig.modlessOres || Loader.isModLoaded("basemetals"))){
                if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_antimony_ore") && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_end_antimony_ore")){
                ...
                if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_bismuth_ore") && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_end_bismuth_ore")){
                ...
                if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_copper_ore") && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_end_copper_ore")){
                ...
                if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_lead_ore") && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_end_lead_ore")){
                ...
                if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_mercury_ore") && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_end_mercury_ore")){
                ...
                if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_nickel_ore") && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_end_nickel_ore")){
                ...
                if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_platinum_ore") && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_end_platinum_ore")){
                ...
                if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_silver_ore") && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_end_silver_ore")){
                ...
                if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_tin_ore") && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_end_tin_ore")){
                ...
                if (PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_zinc_ore") && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_end_zinc_ore")){
        ...
        if (PoorMetalsConfig.netherModernMetalsPoorOres && PoorMetalsConfig.modernMetalsPoorOres && (PoorMetalsConfig.modlessOres || (Loader.isModLoaded("nethermetals") && Loader.isModLoaded("modernmetals")))){
        ...
        if (PoorMetalsConfig.endModernMetalsPoorOres && PoorMetalsConfig.modernMetalsPoorOres && (PoorMetalsConfig.modlessOres || (Loader.isModLoaded("endmetals") && Loader.isModLoaded("modernmetals")))){
    ...
    private static void initCrackhammerRecipes(){
        if (PoorMetalsConfig.poorOreCrackHammer && Loader.isModLoaded("mmdlib")){
            int smallDustAmount = PoorMetalsConfig.poorOreDouble ? 6 : 3;
            if (Loader.isModLoaded("basemetals")){
                if (PoorMetalsConfig.vanillaPoorOres){
                    CrusherRecipeRegistry.addNewCrusherRecipe("orePoorGold", Materials.getMaterialByName(MaterialNames.GOLD).getItemStack(Names.SMALLPOWDER, smallDustAmount));
                    CrusherRecipeRegistry.addNewCrusherRecipe("orePoorIron", Materials.getMaterialByName(MaterialNames.IRON).getItemStack(Names.SMALLPOWDER, smallDustAmount));
                }

                if (PoorMetalsConfig.baseMetalsPoorOres){
                    for (String matName : myMaterialNamesBme) {
                        if (Materials.hasMaterial(matName) && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_" + matName + "_ore")){
                            ...
                            ItemStack smallPowder = mat.getItemStack(Names.SMALLPOWDER, smallDustAmount);
            ...
            if (Loader.isModLoaded("modernmetals")){
                ...
                if (Loader.isModLoaded("nethermetals") && PoorMetalsConfig.netherModernMetalsPoorOres){
                    for (String matName : myMaterialNamesMme) {
                        ...
                        if (Materials.hasMaterial(matName) && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_nether_" + matName + "_ore")){
                            MMDMaterial mat = Materials.getMaterialByName(matName);
                            String oreName = mat.getCapitalizedName();
                            String poorOreName = "orePoorNether" + oreName;
                            ItemStack smallPowder = mat.getItemStack(Names.SMALLPOWDER, smallDustAmount * 2);
                            CrusherRecipeRegistry.addNewCrusherRecipe(poorOreName, smallPowder);
                        }
                    }
                }
                if (Loader.isModLoaded("endmetals") && PoorMetalsConfig.endModernMetalsPoorOres){
                    for (String matName : myMaterialNamesMme) {
                        ...
                        if (Materials.hasMaterial(matName) && PoorMetalsConfig.individualToggles.ENABLED_ORES.get("poor_end_" + matName + "_ore")){
                            MMDMaterial mat = Materials.getMaterialByName(matName);
                            String oreName = mat.getCapitalizedName();
    ...
    private static void initOreDictionary(){
        ...
        if (PoorMetalsConfig.modlessOres || Loader.isModLoaded("basemetals")){
            if (PoorMetalsConfig.baseMetalsPoorOres){
            ...
            if (PoorMetalsConfig.modlessOres || Loader.isModLoaded("nethermetals")){
            ...
            if (PoorMetalsConfig.modlessOres || Loader.isModLoaded("endmetals")){
        ...
        if (PoorMetalsConfig.modlessOres || Loader.isModLoaded("modernmetals")){
            if (PoorMetalsConfig.modernMetalsPoorOres){
